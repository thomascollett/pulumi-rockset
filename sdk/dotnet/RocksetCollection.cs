...
namespace Collett.Rockset
{
    ...
    /// </summary>
    [RocksetResourceType("rockset:index/rocksetCollection:RocksetCollection")]
    public partial class RocksetCollection : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public RocksetCollection(string name, RocksetCollectionArgs args, CustomResourceOptions? options = null)
            : base("rockset:index/rocksetCollection:RocksetCollection", name, args ?? new RocksetCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RocksetCollection(string name, Input<string> id, RocksetCollectionState? state = null, CustomResourceOptions? options = null)
            : base("rockset:index/rocksetCollection:RocksetCollection", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RocksetCollection Get(string name, Input<string> id, RocksetCollectionState? state = null, CustomResourceOptions? options = null)
        {
            return new RocksetCollection(name, id, state, options);
        }
    }

    public sealed class RocksetCollectionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Text describing the collection.
        /// </summary>
        ...
        public RocksetCollectionArgs()
        {
        }
        public static new RocksetCollectionArgs Empty => new RocksetCollectionArgs();
    }

    public sealed class RocksetCollectionState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Text describing the collection.
        /// </summary>
        ...
        public RocksetCollectionState()
        {
        }
        public static new RocksetCollectionState Empty => new RocksetCollectionState();
    }
}
