...
namespace Collett.Rockset.Inputs
{
    ...
    public sealed class RocksetS3CollectionSourceCsvGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("columnNames")]
        ...
        public RocksetS3CollectionSourceCsvGetArgs()
        {
        }
        public static new RocksetS3CollectionSourceCsvGetArgs Empty => new RocksetS3CollectionSourceCsvGetArgs();
    }
}
