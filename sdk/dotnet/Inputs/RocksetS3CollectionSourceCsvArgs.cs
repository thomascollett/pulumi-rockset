...
namespace Collett.Rockset.Inputs
{
    ...
    public sealed class RocksetS3CollectionSourceCsvArgs : global::Pulumi.ResourceArgs
    {
        [Input("columnNames")]
        ...
        public RocksetS3CollectionSourceCsvArgs()
        {
        }
        public static new RocksetS3CollectionSourceCsvArgs Empty => new RocksetS3CollectionSourceCsvArgs();
    }
}
