...
import io.collett.pulumi.rockset.inputs.RocksetGcsCollectionSourceArgs;
...
public final class RocksetGcsCollectionState extends com.pulumi.resources.ResourceArgs {

    public static final RocksetGcsCollectionState Empty = new RocksetGcsCollectionState();
     ...
     */
    @Import(name="sources")
    private @Nullable Output<List<RocksetGcsCollectionSourceArgs>> sources;

    /**
     * @return Defines a source for this collection.
     * 
     */
    public Optional<Output<List<RocksetGcsCollectionSourceArgs>>> sources() {
    ...
    private RocksetGcsCollectionState() {}

    private RocksetGcsCollectionState(RocksetGcsCollectionState $) {
    ...
    public static Builder builder(RocksetGcsCollectionState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RocksetGcsCollectionState();
        }

        public Builder(RocksetGcsCollectionState defaults) {
            $ = new RocksetGcsCollectionState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder sources(@Nullable Output<List<RocksetGcsCollectionSourceArgs>> sources) {
            $.sources = sources;
            return this;
        }
         ...
         * 
         */
        public Builder sources(List<RocksetGcsCollectionSourceArgs> sources) {
         ...
         * 
         */
        public Builder sources(RocksetGcsCollectionSourceArgs... sources) {
        ...
        public RocksetGcsCollectionState build() {
            return $;
        }
    }
