...
import io.collett.pulumi.rockset.inputs.RocksetKinesisCollectionSourceArgs;
...
public final class RocksetKinesisCollectionState extends com.pulumi.resources.ResourceArgs {

    public static final RocksetKinesisCollectionState Empty = new RocksetKinesisCollectionState();
     ...
     */
    @Import(name="sources")
    private @Nullable Output<List<RocksetKinesisCollectionSourceArgs>> sources;

    /**
     * @return Defines a source for this collection.
     * 
     */
    public Optional<Output<List<RocksetKinesisCollectionSourceArgs>>> sources() {
    ...
    private RocksetKinesisCollectionState() {}

    private RocksetKinesisCollectionState(RocksetKinesisCollectionState $) {
    ...
    public static Builder builder(RocksetKinesisCollectionState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RocksetKinesisCollectionState();
        }

        public Builder(RocksetKinesisCollectionState defaults) {
            $ = new RocksetKinesisCollectionState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder sources(@Nullable Output<List<RocksetKinesisCollectionSourceArgs>> sources) {
            $.sources = sources;
            return this;
        }
         ...
         * 
         */
        public Builder sources(List<RocksetKinesisCollectionSourceArgs> sources) {
         ...
         * 
         */
        public Builder sources(RocksetKinesisCollectionSourceArgs... sources) {
        ...
        public RocksetKinesisCollectionState build() {
            return $;
        }
    }
