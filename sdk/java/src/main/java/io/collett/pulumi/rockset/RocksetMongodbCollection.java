...
import io.collett.pulumi.rockset.RocksetMongodbCollectionArgs;
import io.collett.pulumi.rockset.Utilities;
import io.collett.pulumi.rockset.inputs.RocksetMongodbCollectionState;
import io.collett.pulumi.rockset.outputs.RocksetMongodbCollectionSource;
 ...
 * 
 */
@ResourceType(type="rockset:index/rocksetMongodbCollection:RocksetMongodbCollection")
public class RocksetMongodbCollection extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="sources", type=List.class, parameters={RocksetMongodbCollectionSource.class})
    private Output</* @Nullable */ List<RocksetMongodbCollectionSource>> sources;

    /**
     * @return Defines a source for this collection.
     * 
     */
    public Output<Optional<List<RocksetMongodbCollectionSource>>> sources() {
     ...
     */
    public RocksetMongodbCollection(String name) {
        this(name, RocksetMongodbCollectionArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RocksetMongodbCollection(String name, RocksetMongodbCollectionArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RocksetMongodbCollection(String name, RocksetMongodbCollectionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("rockset:index/rocksetMongodbCollection:RocksetMongodbCollection", name, args == null ? RocksetMongodbCollectionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RocksetMongodbCollection(String name, Output<String> id, @Nullable RocksetMongodbCollectionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("rockset:index/rocksetMongodbCollection:RocksetMongodbCollection", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static RocksetMongodbCollection get(String name, Output<String> id, @Nullable RocksetMongodbCollectionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
