...
import io.collett.pulumi.rockset.RocksetDynamodbCollectionArgs;
import io.collett.pulumi.rockset.Utilities;
import io.collett.pulumi.rockset.inputs.RocksetDynamodbCollectionState;
import io.collett.pulumi.rockset.outputs.RocksetDynamodbCollectionSource;
 ...
 * 
 */
@ResourceType(type="rockset:index/rocksetDynamodbCollection:RocksetDynamodbCollection")
public class RocksetDynamodbCollection extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="sources", type=List.class, parameters={RocksetDynamodbCollectionSource.class})
    private Output</* @Nullable */ List<RocksetDynamodbCollectionSource>> sources;

    /**
     * @return Defines a source for this collection.
     * 
     */
    public Output<Optional<List<RocksetDynamodbCollectionSource>>> sources() {
     ...
     */
    public RocksetDynamodbCollection(String name) {
        this(name, RocksetDynamodbCollectionArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RocksetDynamodbCollection(String name, RocksetDynamodbCollectionArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RocksetDynamodbCollection(String name, RocksetDynamodbCollectionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("rockset:index/rocksetDynamodbCollection:RocksetDynamodbCollection", name, args == null ? RocksetDynamodbCollectionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RocksetDynamodbCollection(String name, Output<String> id, @Nullable RocksetDynamodbCollectionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("rockset:index/rocksetDynamodbCollection:RocksetDynamodbCollection", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static RocksetDynamodbCollection get(String name, Output<String> id, @Nullable RocksetDynamodbCollectionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
