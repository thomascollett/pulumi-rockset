...
public final class RocksetS3CollectionSourceXmlArgs extends com.pulumi.resources.ResourceArgs {

    public static final RocksetS3CollectionSourceXmlArgs Empty = new RocksetS3CollectionSourceXmlArgs();
    ...
    private RocksetS3CollectionSourceXmlArgs() {}

    private RocksetS3CollectionSourceXmlArgs(RocksetS3CollectionSourceXmlArgs $) {
    ...
    public static Builder builder(RocksetS3CollectionSourceXmlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RocksetS3CollectionSourceXmlArgs();
        }

        public Builder(RocksetS3CollectionSourceXmlArgs defaults) {
            $ = new RocksetS3CollectionSourceXmlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RocksetS3CollectionSourceXmlArgs build() {
            return $;
        }
    }
