...
import io.collett.pulumi.rockset.inputs.RocksetMongodbCollectionSourceArgs;
...
public final class RocksetMongodbCollectionState extends com.pulumi.resources.ResourceArgs {

    public static final RocksetMongodbCollectionState Empty = new RocksetMongodbCollectionState();
     ...
     */
    @Import(name="sources")
    private @Nullable Output<List<RocksetMongodbCollectionSourceArgs>> sources;

    /**
     * @return Defines a source for this collection.
     * 
     */
    public Optional<Output<List<RocksetMongodbCollectionSourceArgs>>> sources() {
    ...
    private RocksetMongodbCollectionState() {}

    private RocksetMongodbCollectionState(RocksetMongodbCollectionState $) {
    ...
    public static Builder builder(RocksetMongodbCollectionState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RocksetMongodbCollectionState();
        }

        public Builder(RocksetMongodbCollectionState defaults) {
            $ = new RocksetMongodbCollectionState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder sources(@Nullable Output<List<RocksetMongodbCollectionSourceArgs>> sources) {
            $.sources = sources;
            return this;
        }
         ...
         * 
         */
        public Builder sources(List<RocksetMongodbCollectionSourceArgs> sources) {
         ...
         * 
         */
        public Builder sources(RocksetMongodbCollectionSourceArgs... sources) {
        ...
        public RocksetMongodbCollectionState build() {
            return $;
        }
    }
