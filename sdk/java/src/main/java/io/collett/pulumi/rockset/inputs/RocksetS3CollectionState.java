...
import io.collett.pulumi.rockset.inputs.RocksetS3CollectionSourceArgs;
...
public final class RocksetS3CollectionState extends com.pulumi.resources.ResourceArgs {

    public static final RocksetS3CollectionState Empty = new RocksetS3CollectionState();
     ...
     */
    @Import(name="sources")
    private @Nullable Output<List<RocksetS3CollectionSourceArgs>> sources;

    /**
     * @return Defines a source for this collection.
     * 
     */
    public Optional<Output<List<RocksetS3CollectionSourceArgs>>> sources() {
    ...
    private RocksetS3CollectionState() {}

    private RocksetS3CollectionState(RocksetS3CollectionState $) {
    ...
    public static Builder builder(RocksetS3CollectionState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RocksetS3CollectionState();
        }

        public Builder(RocksetS3CollectionState defaults) {
            $ = new RocksetS3CollectionState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder sources(@Nullable Output<List<RocksetS3CollectionSourceArgs>> sources) {
            $.sources = sources;
            return this;
        }
         ...
         * 
         */
        public Builder sources(List<RocksetS3CollectionSourceArgs> sources) {
         ...
         * 
         */
        public Builder sources(RocksetS3CollectionSourceArgs... sources) {
        ...
        public RocksetS3CollectionState build() {
            return $;
        }
    }
