...
import io.collett.pulumi.rockset.inputs.RocksetKafkaCollectionSourceArgs;
...
public final class RocksetKafkaCollectionState extends com.pulumi.resources.ResourceArgs {

    public static final RocksetKafkaCollectionState Empty = new RocksetKafkaCollectionState();
     ...
     */
    @Import(name="sources")
    private @Nullable Output<List<RocksetKafkaCollectionSourceArgs>> sources;

    /**
     * @return Defines a source for this collection.
     * 
     */
    public Optional<Output<List<RocksetKafkaCollectionSourceArgs>>> sources() {
    ...
    private RocksetKafkaCollectionState() {}

    private RocksetKafkaCollectionState(RocksetKafkaCollectionState $) {
    ...
    public static Builder builder(RocksetKafkaCollectionState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RocksetKafkaCollectionState();
        }

        public Builder(RocksetKafkaCollectionState defaults) {
            $ = new RocksetKafkaCollectionState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder sources(@Nullable Output<List<RocksetKafkaCollectionSourceArgs>> sources) {
            $.sources = sources;
            return this;
        }
         ...
         * 
         */
        public Builder sources(List<RocksetKafkaCollectionSourceArgs> sources) {
         ...
         * 
         */
        public Builder sources(RocksetKafkaCollectionSourceArgs... sources) {
        ...
        public RocksetKafkaCollectionState build() {
            return $;
        }
    }
