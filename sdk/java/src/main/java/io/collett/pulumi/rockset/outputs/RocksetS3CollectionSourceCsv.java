...
@CustomType
public final class RocksetS3CollectionSourceCsv {
    ...
    private RocksetS3CollectionSourceCsv() {}
    ...
    public static Builder builder(RocksetS3CollectionSourceCsv defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String separator;
        public Builder() {}
        public Builder(RocksetS3CollectionSourceCsv defaults) {
        ...
        public RocksetS3CollectionSourceCsv build() {
            final var o = new RocksetS3CollectionSourceCsv();
