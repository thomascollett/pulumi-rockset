...
__all__ = ['RocksetKafkaCollectionArgs', 'RocksetKafkaCollection']

@pulumi.input_type
class RocksetKafkaCollectionArgs:
    def __init__(__self__, *,
                 ...
                 sources: Optional[pulumi.Input[Sequence[pulumi.Input['RocksetKafkaCollectionSourceArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RocksetKafkaCollectionSourceArgs']]] sources: Defines a source for this collection.
    ...
    @property
    @pulumi.getter
    def sources(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['RocksetKafkaCollectionSourceArgs']]]]:
        """
    ...
    @sources.setter
    def sources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['RocksetKafkaCollectionSourceArgs']]]]):
...
@pulumi.input_type
class _RocksetKafkaCollectionState:
    def __init__(__self__, *,
                 description: Optional[pulumi.Input[str]] = None,
                 field_mapping_query: Optional[pulumi.Input[str]] = None,
                 ingest_transformation: Optional[pulumi.Input[str]] = None,
...
class RocksetKafkaCollection(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 name: Optional[pulumi.Input[str]] = None,
                 retention_secs: Optional[pulumi.Input[int]] = None,
                 sources: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RocksetKafkaCollectionSourceArgs']]]]] = None,
                 wait_for_collection: Optional[pulumi.Input[bool]] = None,
                 wait_for_documents: Optional[pulumi.Input[int]] = None,
                 workspace: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        ...
        :param pulumi.Input[str] name: Unique identifier for the collection. Can contain alphanumeric or dash characters.
        :param pulumi.Input[int] retention_secs: Number of seconds after which data is purged. Based on event time.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RocksetKafkaCollectionSourceArgs']]]] sources: Defines a source for this collection.
        :param pulumi.Input[bool] wait_for_collection: Wait until the collection is ready.
        :param pulumi.Input[int] wait_for_documents: Wait until the collection has documents. The default is to wait for 0 documents, which means it doesn't wait.
        :param pulumi.Input[str] workspace: The name of the workspace.
        """
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: RocksetKafkaCollectionArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Manages a collection created from a Kafka source. The `use_v3` field must match the integration which the collection is created from.
        ...
        :param str resource_name: The name of the resource.
        :param RocksetKafkaCollectionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RocksetKafkaCollectionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RocksetKafkaCollectionArgs.__new__(RocksetKafkaCollectionArgs)
        ...
        super(RocksetKafkaCollection, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            wait_for_collection: Optional[pulumi.Input[bool]] = None,
            wait_for_documents: Optional[pulumi.Input[int]] = None,
            workspace: Optional[pulumi.Input[str]] = None) -> 'RocksetKafkaCollection':
        """
        ...
        __props__ = _RocksetKafkaCollectionState.__new__(_RocksetKafkaCollectionState)
        ...
        __props__.__dict__["wait_for_documents"] = wait_for_documents
        __props__.__dict__["workspace"] = workspace
        return RocksetKafkaCollection(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def sources(self) -> pulumi.Output[Optional[Sequence['outputs.RocksetKafkaCollectionSource']]]:
        """
        Defines a source for this collection.
        """
        return pulumi.get(self, "sources")
