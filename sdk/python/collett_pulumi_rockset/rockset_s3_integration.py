...
__all__ = ['RocksetS3IntegrationArgs', 'RocksetS3Integration']

@pulumi.input_type
class RocksetS3IntegrationArgs:
...
@pulumi.input_type
class _RocksetS3IntegrationState:
    def __init__(__self__, *,
...
class RocksetS3Integration(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: RocksetS3IntegrationArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Manages a Rockset S3 Integration.

        :param str resource_name: The name of the resource.
        :param RocksetS3IntegrationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RocksetS3IntegrationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RocksetS3IntegrationArgs.__new__(RocksetS3IntegrationArgs)
        ...
        super(RocksetS3Integration, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            aws_role_arn: Optional[pulumi.Input[str]] = None,
            description: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None) -> 'RocksetS3Integration':
        """
        ...
        __props__ = _RocksetS3IntegrationState.__new__(_RocksetS3IntegrationState)

        __props__.__dict__["aws_role_arn"] = aws_role_arn
        __props__.__dict__["description"] = description
        __props__.__dict__["name"] = name
        return RocksetS3Integration(resource_name, opts=opts, __props__=__props__)
