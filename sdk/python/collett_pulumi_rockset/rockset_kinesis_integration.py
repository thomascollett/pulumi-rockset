...
__all__ = ['RocksetKinesisIntegrationArgs', 'RocksetKinesisIntegration']

@pulumi.input_type
class RocksetKinesisIntegrationArgs:
...
@pulumi.input_type
class _RocksetKinesisIntegrationState:
    def __init__(__self__, *,
...
class RocksetKinesisIntegration(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: RocksetKinesisIntegrationArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Manages a Rockset Kinesis Integration.

        :param str resource_name: The name of the resource.
        :param RocksetKinesisIntegrationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RocksetKinesisIntegrationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RocksetKinesisIntegrationArgs.__new__(RocksetKinesisIntegrationArgs)
        ...
        super(RocksetKinesisIntegration, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            aws_role_arn: Optional[pulumi.Input[str]] = None,
            description: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None) -> 'RocksetKinesisIntegration':
        """
        ...
        __props__ = _RocksetKinesisIntegrationState.__new__(_RocksetKinesisIntegrationState)

        __props__.__dict__["aws_role_arn"] = aws_role_arn
        __props__.__dict__["description"] = description
        __props__.__dict__["name"] = name
        return RocksetKinesisIntegration(resource_name, opts=opts, __props__=__props__)
