...
__all__ = ['RocksetS3CollectionArgs', 'RocksetS3Collection']

@pulumi.input_type
class RocksetS3CollectionArgs:
    def __init__(__self__, *,
                 ...
                 sources: Optional[pulumi.Input[Sequence[pulumi.Input['RocksetS3CollectionSourceArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RocksetS3CollectionSourceArgs']]] sources: Defines a source for this collection.
    ...
    @property
    @pulumi.getter
    def sources(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['RocksetS3CollectionSourceArgs']]]]:
        """
    ...
    @sources.setter
    def sources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['RocksetS3CollectionSourceArgs']]]]):
...
@pulumi.input_type
class _RocksetS3CollectionState:
    def __init__(__self__, *,
                 description: Optional[pulumi.Input[str]] = None,
                 field_mapping_query: Optional[pulumi.Input[str]] = None,
                 ingest_transformation: Optional[pulumi.Input[str]] = None,
...
class RocksetS3Collection(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 name: Optional[pulumi.Input[str]] = None,
                 retention_secs: Optional[pulumi.Input[int]] = None,
                 sources: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RocksetS3CollectionSourceArgs']]]]] = None,
                 wait_for_collection: Optional[pulumi.Input[bool]] = None,
                 wait_for_documents: Optional[pulumi.Input[int]] = None,
                 workspace: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        ...
        :param pulumi.Input[str] name: Unique identifier for the collection. Can contain alphanumeric or dash characters.
        :param pulumi.Input[int] retention_secs: Number of seconds after which data is purged. Based on event time.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RocksetS3CollectionSourceArgs']]]] sources: Defines a source for this collection.
        :param pulumi.Input[bool] wait_for_collection: Wait until the collection is ready.
        :param pulumi.Input[int] wait_for_documents: Wait until the collection has documents. The default is to wait for 0 documents, which means it doesn't wait.
        :param pulumi.Input[str] workspace: The name of the workspace.
        """
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param RocksetS3CollectionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RocksetS3CollectionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RocksetS3CollectionArgs.__new__(RocksetS3CollectionArgs)
        ...
        super(RocksetS3Collection, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            wait_for_collection: Optional[pulumi.Input[bool]] = None,
            wait_for_documents: Optional[pulumi.Input[int]] = None,
            workspace: Optional[pulumi.Input[str]] = None) -> 'RocksetS3Collection':
        """
        ...
        __props__ = _RocksetS3CollectionState.__new__(_RocksetS3CollectionState)
        ...
        __props__.__dict__["wait_for_documents"] = wait_for_documents
        __props__.__dict__["workspace"] = workspace
        return RocksetS3Collection(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def sources(self) -> pulumi.Output[Optional[Sequence['outputs.RocksetS3CollectionSource']]]:
        """
        Defines a source for this collection.
        """
        return pulumi.get(self, "sources")
