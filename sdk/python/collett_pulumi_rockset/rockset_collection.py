...
__all__ = ['RocksetCollectionArgs', 'RocksetCollection']

@pulumi.input_type
class RocksetCollectionArgs:
...
class RocksetCollection(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: RocksetCollectionArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Manages a basic collection with no sources. Usually used for the write api.

        :param str resource_name: The name of the resource.
        :param RocksetCollectionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RocksetCollectionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RocksetCollectionArgs.__new__(RocksetCollectionArgs)
        ...
        super(RocksetCollection, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            wait_for_collection: Optional[pulumi.Input[bool]] = None,
            wait_for_documents: Optional[pulumi.Input[int]] = None,
            workspace: Optional[pulumi.Input[str]] = None) -> 'RocksetCollection':
        """
        ...
        __props__ = _RocksetCollectionState.__new__(_RocksetCollectionState)
        ...
        __props__.__dict__["wait_for_documents"] = wait_for_documents
        __props__.__dict__["workspace"] = workspace
        return RocksetCollection(resource_name, opts=opts, __props__=__props__)
