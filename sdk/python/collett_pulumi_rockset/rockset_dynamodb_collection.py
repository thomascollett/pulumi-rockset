...
__all__ = ['RocksetDynamodbCollectionArgs', 'RocksetDynamodbCollection']

@pulumi.input_type
class RocksetDynamodbCollectionArgs:
    def __init__(__self__, *,
                 ...
                 sources: Optional[pulumi.Input[Sequence[pulumi.Input['RocksetDynamodbCollectionSourceArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RocksetDynamodbCollectionSourceArgs']]] sources: Defines a source for this collection.
    ...
    @property
    @pulumi.getter
    def sources(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['RocksetDynamodbCollectionSourceArgs']]]]:
        """
    ...
    @sources.setter
    def sources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['RocksetDynamodbCollectionSourceArgs']]]]):
...
@pulumi.input_type
class _RocksetDynamodbCollectionState:
    def __init__(__self__, *,
                 description: Optional[pulumi.Input[str]] = None,
                 field_mapping_query: Optional[pulumi.Input[str]] = None,
                 ingest_transformation: Optional[pulumi.Input[str]] = None,
...
class RocksetDynamodbCollection(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 name: Optional[pulumi.Input[str]] = None,
                 retention_secs: Optional[pulumi.Input[int]] = None,
                 sources: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RocksetDynamodbCollectionSourceArgs']]]]] = None,
                 wait_for_collection: Optional[pulumi.Input[bool]] = None,
                 wait_for_documents: Optional[pulumi.Input[int]] = None,
                 workspace: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        ...
        :param pulumi.Input[str] name: Unique identifier for the collection. Can contain alphanumeric or dash characters.
        :param pulumi.Input[int] retention_secs: Number of seconds after which data is purged. Based on event time.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RocksetDynamodbCollectionSourceArgs']]]] sources: Defines a source for this collection.
        :param pulumi.Input[bool] wait_for_collection: Wait until the collection is ready.
        :param pulumi.Input[int] wait_for_documents: Wait until the collection has documents. The default is to wait for 0 documents, which means it doesn't wait.
        :param pulumi.Input[str] workspace: The name of the workspace.
        """
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: RocksetDynamodbCollectionArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Manages a collection with an DynamoDB source attached.

        :param str resource_name: The name of the resource.
        :param RocksetDynamodbCollectionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RocksetDynamodbCollectionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RocksetDynamodbCollectionArgs.__new__(RocksetDynamodbCollectionArgs)
        ...
        super(RocksetDynamodbCollection, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            wait_for_collection: Optional[pulumi.Input[bool]] = None,
            wait_for_documents: Optional[pulumi.Input[int]] = None,
            workspace: Optional[pulumi.Input[str]] = None) -> 'RocksetDynamodbCollection':
        """
        ...
        __props__ = _RocksetDynamodbCollectionState.__new__(_RocksetDynamodbCollectionState)
        ...
        __props__.__dict__["wait_for_documents"] = wait_for_documents
        __props__.__dict__["workspace"] = workspace
        return RocksetDynamodbCollection(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def sources(self) -> pulumi.Output[Optional[Sequence['outputs.RocksetDynamodbCollectionSource']]]:
        """
        Defines a source for this collection.
        """
        return pulumi.get(self, "sources")
