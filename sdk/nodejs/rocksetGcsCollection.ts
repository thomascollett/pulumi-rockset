 ...
 */
export class RocksetGcsCollection extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RocksetGcsCollectionState, opts?: pulumi.CustomResourceOptions): RocksetGcsCollection {
        return new RocksetGcsCollection(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'rockset:index/rocksetGcsCollection:RocksetGcsCollection';

    /**
     * Returns true if the given object is an instance of RocksetGcsCollection.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RocksetGcsCollection {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RocksetGcsCollection.__pulumiType;
    }
     ...
     */
    public readonly sources!: pulumi.Output<outputs.RocksetGcsCollectionSource[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: RocksetGcsCollectionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RocksetGcsCollectionArgs | RocksetGcsCollectionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RocksetGcsCollectionState | undefined;
            ...
            const args = argsOrState as RocksetGcsCollectionArgs | undefined;
        ...
        super(RocksetGcsCollection.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RocksetGcsCollectionState {
    /**
     * Text describing the collection.
     */
     ...
     * Defines a source for this collection.
     */
    sources?: pulumi.Input<pulumi.Input<inputs.RocksetGcsCollectionSource>[]>;
    /**
     * Wait until the collection is ready.
     */
 ...
 */
export interface RocksetGcsCollectionArgs {
    /**
     * Text describing the collection.
     */
    description?: pulumi.Input<string>;
