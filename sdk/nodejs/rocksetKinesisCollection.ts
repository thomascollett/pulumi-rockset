 ...
 */
export class RocksetKinesisCollection extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RocksetKinesisCollectionState, opts?: pulumi.CustomResourceOptions): RocksetKinesisCollection {
        return new RocksetKinesisCollection(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'rockset:index/rocksetKinesisCollection:RocksetKinesisCollection';

    /**
     * Returns true if the given object is an instance of RocksetKinesisCollection.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RocksetKinesisCollection {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RocksetKinesisCollection.__pulumiType;
    }
     ...
     */
    public readonly sources!: pulumi.Output<outputs.RocksetKinesisCollectionSource[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: RocksetKinesisCollectionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RocksetKinesisCollectionArgs | RocksetKinesisCollectionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RocksetKinesisCollectionState | undefined;
            ...
            const args = argsOrState as RocksetKinesisCollectionArgs | undefined;
        ...
        super(RocksetKinesisCollection.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RocksetKinesisCollectionState {
    /**
     * Text describing the collection.
     */
     ...
     * Defines a source for this collection.
     */
    sources?: pulumi.Input<pulumi.Input<inputs.RocksetKinesisCollectionSource>[]>;
    /**
     * Wait until the collection is ready.
     */
 ...
 */
export interface RocksetKinesisCollectionArgs {
    /**
     * Text describing the collection.
     */
    description?: pulumi.Input<string>;
